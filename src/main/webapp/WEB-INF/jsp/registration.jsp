...
<!-- banner -->
	...
	<div class="banner-dott">
		<div class="main">
            <h1 class="w3layouts_head"><font face="permanent marker">Thanks for signing up!</font></h1>
				<div class="w3layouts_main_grid">
					<form:form action="/registration" method="Post" modelAttribute="userLogin" class="w3_form_post">
         ...
         document.getElementById("demo").innerHTML = txt;
					    ...
					    <div class="agileits_w3layouts_main_grid w3ls_main_grid">
							...
							<span class="agileinfo_grid">
								<label>Seeking</label>
								<div class="agileits_w3layouts_main_gridl">
								<form:textarea name="comment" path="seeking"></form:textarea>
								</span>
						</div>
					<br>
					<br>
